...
AndroidDriver<AndroidElement> driver;
	...
	public void testcase() throws InterruptedException
	{
		...
		//driver.findElement(By.xpath("//*[@class="gLFyf"]")).sendKeys("virat kohli"); 
...
//	   
//	    Actions  busa= new Actions(driver);
//		busa.moveToElement(driver.findElement(By.xpath("//*[@href='https://in.linkedin.com/company/moolyaed']")));
//         busa.click().build().perform();
//	
